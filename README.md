...
My work focuses on building reliable automation systems with **n8n**, AI models, APIs, data processing, and business integrations.
...
- Automate email, appointment, invoice, and data-processing workflows

- Integrate AI models into practical business use cases

- Create structured data pipelines with validation and deduplication

- Build human-in-the-loop processes for safer automation
...
| [Icebreaker Generator](https://github.com/fatmahussein821/icebreaker-generator) | Scheduled workflow that discovers and researches prospects in a selected location, analyzes their company websites with Gemini, generates automation-focused icebreakers, and stores enriched records in Google Sheets.|
...
I am currently open to **AI Automation Engineer** roles and opportunities to contribute to real-world automation projects, learn from experienced teams, and build intelligent business workflows.

## Contact

- Email: [fatmahuss678@gmail.com](mailto:fatmahuss678@gmail.com)

---

*Building practical automation systems that connect AI with real business workflows.*
